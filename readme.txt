...
= 6.1.3 =
* Legacy widget: solving settings save bug when chaning checkboxes.
* Legacy widget: solving settings load when using the widget mode.
* Legacy widget: rewriting clicking event function to avoid some bugs and issues with certain settings.
